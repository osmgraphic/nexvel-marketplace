...
contract FullDeploy is Script {
    function run() external {
        ...
        /*//////////////////////////////////////////////////////////////
                            REGISTRY
        //////////////////////////////////////////////////////////////*/
        MarketplaceAddressRegistry deployedRegistry = new MarketplaceAddressRegistry(admin);
        ...
        /*//////////////////////////////////////////////////////////////
                            SECURITY (UUPS)
        //////////////////////////////////////////////////////////////*/
        NexvelSecurityImpl securityImpl = new NexvelSecurityImpl();

        address security = address(
            new ERC1967Proxy(
                address(securityImpl),
                abi.encodeWithSelector(
                    NexvelSecurityImpl.initialize.selector, admin, operator, address(deployedRegistry), creators
                )
            )
        );
        ...
        //////////////////////////////////////////////////////////////*/
        NexvelMarketplaceV3 marketplaceImpl = new NexvelMarketplaceV3();

        address marketplace = address(
            new ERC1967Proxy(
                address(marketplaceImpl),
                abi.encodeWithSelector(
                    bytes4(keccak256("initialize(address,address,address,address[],address,uint96,uint256)")),
                    admin,
                    operator,
        ...
        /*//////////////////////////////////////////////////////////////
                            LAUNCHPAD (UUPS)
        //////////////////////////////////////////////////////////////*/
        NexvelLaunchpad launchpadImpl = new NexvelLaunchpad();
        ...
        /*//////////////////////////////////////////////////////////////
                            ERC1155 (UUPS)
        //////////////////////////////////////////////////////////////*/
        NexvelERC1155Upgradeable erc1155Impl = new NexvelERC1155Upgradeable();
        ...
        //////////////////////////////////////////////////////////////*/
        NexvelERC721Impl erc721Impl = new NexvelERC721Impl();
        ...
        //////////////////////////////////////////////////////////////*/
        NexvelERC721A erc721AImpl = new NexvelERC721A();
        ...
        //////////////////////////////////////////////////////////////*/
        address factory =
            address(new NexvelNFTFactory(admin, address(deployedRegistry), erc721ImplAddr, erc721AImplAddr));
        ...
        require(deployedRegistry.isInitialized(), "Registry not initialized");
        ...
        console2.log("========================================");
        console2.log("Registry      :", address(deployedRegistry));
        ...
        console2.log("Registry Initialized :", deployedRegistry.isInitialized());

        console2.log("Protocol             : Nexvel Marketplace");

        console2.log("Version              : 1");
    }
}
