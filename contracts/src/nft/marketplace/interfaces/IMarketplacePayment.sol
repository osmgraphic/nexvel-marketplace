...
interface IMarketplacePayment {
    ...
    function executeSale(MarketplaceTypes.PaymentRequest calldata request)
        external
        payable
        returns (MarketplaceTypes.FeeBreakdown memory breakdown);

    /// @notice Executes an auction settlement.
    /// @param request Payment execution request.
    /// @return breakdown Complete payment breakdown.
    function executeAuctionSettlement(MarketplaceTypes.PaymentRequest calldata request)
        external
        payable
        returns (MarketplaceTypes.FeeBreakdown memory breakdown);
    ...
    function calculateFees(MarketplaceTypes.PaymentRequest calldata request)
        external
        view
        returns (MarketplaceTypes.FeeBreakdown memory breakdown);
}
