...
contract NexvelNFTFactory is ReentrancyGuard {
    ...
    modifier onlyCreator() {
        ...
        require(
            NexvelSecurityUpgradeable(securityAddr).hasRole(
                NexvelSecurityUpgradeable(securityAddr).CREATOR_ROLE(),
                msg.sender
            ),
            "Not creator"
        );
        ...
        returns (address collection)
    {
        address implementation =
            nftType == NFTType.ERC721 ? erc721Impl : erc721AImpl;
