    ...
    NexvelSecurityUpgradeable
{
    ...
    event Listed(uint256 indexed listingId,address indexed nft,uint256 indexed tokenId,address seller,uint256 price,address paymentToken,bool isERC20);
    ...
    function setMarketplaceFeeRecipient(address newRecipient)
        external
        onlyRole(ADMIN_ROLE)
    {
    ...
    function setMaxTradeValue(uint256 newValue)
        external
        onlyRole(ADMIN_ROLE)
    {
    ...
    function setAllowedCollection(address nft, bool allowed)
        external
        onlyRole(ADMIN_ROLE)
    {
    ...
    function _handlePayment(
        ...
        try IERC2981(nft).royaltyInfo(tokenId, amount)
    ...
    function cancelListing(address token, uint256 tokenId)
        external
        nonReentrant
    {
    ...
    function emergencyCancelListing(address token, uint256 tokenId)
        external
        onlyAdmin
        nonReentrant
    {
