export default [
  ...
  {
    "type": "event",
    "name": "EmergencyListingCancelled",
    "inputs": [
      {
        "name": "nft",
        "type": "address",
