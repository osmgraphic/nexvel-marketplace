...
contract NexvelMarketplaceV3 is NexvelMarketplaceV2, IERC1155Receiver {
    ...
    function bid1155(uint256 auctionId)
        external
        payable
        nonReentrant
        whenNotPaused
    ...
    function settleAuction1155(uint256 auctionId)
        external
        nonReentrant
        whenNotPaused
        whenGlobalNotPaused
    {
        ...
        if (a.highestBidder == address(0)) {
            IERC1155(a.nft).safeTransferFrom(
                address(this),
                a.seller,
                a.tokenId,
                a.amount,
